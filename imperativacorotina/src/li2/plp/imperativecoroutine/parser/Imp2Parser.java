...
/* //TODO: ALTERAR PARA FUNCIONAR COM COROTINAS */
  static final public ComandoCorotina PComandoCorotina() throws ParseException {
    trace_call("PComandoCorotina");
    try {
        ComandoCorotina retorno;
...
/* //TODO ALTERAR PARA FUNCIONAR COM COROTINAS */
  static final public ComandoCorotina PComandoCorotinaSimples() throws ParseException {
  ...
  static final public InterrupcaoCorotina PInterrupcaoCorotina() throws ParseException {
    ...
    try {
      ...
      nomeCorotina = PId();
                {if (true) return new InterrupcaoCorotina(nomeCorotina);}
    throw new Error("Missing return statement in function");
    } finally {
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x23b0000,0x1a3b0000,0x180000,0x6000,0x6000,0x6000,0x1800,0x6000,0x23b0000,0x1a3b0000,0x1008000,0x1000000,0x4000000,0xe0000000,0xe0000000,0xe0000000,0xe0000000,0x0,0x7800,0x0,};
   }

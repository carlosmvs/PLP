...
package li2.plp.imperativecoroutine.parser;
...
import li2.plp.imperativecoroutine.coroutine.*;
import li2.plp.imperativecoroutine.memory.*;
import java.util.*;

public class Imp2Parser extends Coroutine implements Imp2ParserConstants {
        private String[] arguments;

        public Imp2Parser() { }

        public Imp2Parser(String[] arguments) {
        ...
        public void body() {
            ...
            if (arguments.length == 0) {
                System.out.println("Imperativa 2 + Corotina PLP Parser Version 0.0.1:  Reading from standard input . . .");
                parser = new Imp2Parser(System.in);
            } else{
                System.out.println("Imperativa 2 + Corotina PLP Parser Version 0.0.1:  Reading from file " + arguments[0] + " . . .");
                try {
                        parser = new Imp2Parser(new java.io.FileInputStream(arguments[0]));
                } catch (java.io.FileNotFoundException e) {
                        System.out.println("Java Parser Version 1.0.2:  File " + arguments[0] + " not found.");
                        return;
                }
            ...
            if(programa.checaTipo(new ContextoCompilacaoImperativaCorotina(entrada))) {
                ListaValor saida = programa.executar(new ContextoExecucaoImperativaCorotina(entrada));
  ...
  static final public Expressao PExpAbs() throws ParseException {
    trace_call("PExpAbs");
    try {
        Expressao retorno;
      jj_consume_token(ABS);
      retorno = PExpressao();
                {if (true) return new ExpAbs(retorno);}
    throw new Error("Missing return statement in function");
    } finally {
      trace_return("PExpAbs");
    }
  }
  ...
  static final public ExpProduto PExpProduto() throws ParseException {
    trace_call("PExpProduto");
    try {
        Expressao esq;
        Expressao dir;
      esq = PExpPrimaria();
      ...
      dir = PExpressao();
         {if (true) return new ExpProduto(esq, dir);}
    throw new Error("Missing return statement in function");
    } finally {
      trace_return("PExpProduto");
    }
  }
  ...
  static final public ExpDivisao PExpDivisao() throws ParseException {
    ...
    try {
      ...
      dir = PExpressao();
         {if (true) return new ExpDivisao(esq, dir);}
    throw new Error("Missing return statement in function");
    } finally {
  ...
  static final public ExpModulo PExpModulo() throws ParseException {
    trace_call("PExpModulo");
    try {
        Expressao esq;
        Expressao dir;
      esq = PExpPrimaria();
      ...
      dir = PExpressao();
         {if (true) return new ExpModulo(esq, dir);}
    throw new Error("Missing return statement in function");
    } finally {
      trace_return("PExpModulo");
    }
  }
...
/*  ADICIONADO OU MODIFICADO DA Imperativa1 PARA A Imperativa2  */
  ...
  static final public ChamadaCorotina PChamadaCorotina() throws ParseException {
    ...
    try {
      ...
      parametrosAtuais = PListaExpressao();
      jj_consume_token(RPAREN);
                {if (true) return new ChamadaCorotina(nomeCorotina, parametrosAtuais);}
    throw new Error("Missing return statement in function");
    } finally {
      trace_return("PChamadaCorotina");
    }
  }

  static final public Retorno PRetorno() throws ParseException {
    trace_call("PRetorno");
    try {
  Expressao exp = null;
    ...
    throw new Error("Missing return statement in function");
      ...
      trace_return("PRetorno");
    }
  }

  static final public InterrupcaoCorotina PInterrupcaoCorotina() throws ParseException {
    trace_call("PInterrupcaoCorotina");
    try {
  Expressao exp = null;
      ...
      default:
        ...
        ;
         ...
         {if (true) return new InterrupcaoCorotina(exp);}
    throw new Error("Missing return statement in function");
    } finally {
      trace_return("PInterrupcaoCorotina");
    }
  }
  ...
  static final public DeclaracaoCorotina PDeclaracaoCorotina() throws ParseException {
    trace_call("PDeclaracaoCorotina");
    try {
        Id nome;
        DefCorotina defCorotina;
      if (jj_2_20(2147483647)) {
        jj_consume_token(COR);
        nome = PId();
        jj_consume_token(LPAREN);
        jj_consume_token(RPAREN);
        defCorotina = PDefCorotina();
      } else {
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case COR:
          jj_consume_token(COR);
        ...
        default:
          ...
          throw new ParseException();
            ...
            {if (true) return new DeclaracaoCorotina (nome, defCorotina);}
    throw new Error("Missing return statement in function");
    } finally {
      trace_return("PDeclaracaoCorotina");
    }
  }
    ...
    try {
      ...
      case COLON:
        ...
        case COLON:
          ...
          switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
          case BOOLEAN:
            retorno = jj_consume_token(BOOLEAN);
            break;
          case INT:
            retorno = jj_consume_token(INT);
            break;
          case STRING:
            retorno = jj_consume_token(STRING);
            break;
          default:
            jj_la1[13] = jj_gen;
            jj_consume_token(-1);
      ...
      default:
        ...
        throw new ParseException();
            ...
            if(listaPar == null) {
                ...
                if(retorno != null) {
                        if(retorno.kind == BOOLEAN) {
                                {if (true) return new DefProcedimento(listaPar, TipoPrimitivo.BOOLEANO, comando);}
                        }else if(retorno.kind == INT) {
                                {if (true) return new DefProcedimento(listaPar, TipoPrimitivo.INTEIRO, comando);}
                        }else {
                                {if (true) return new DefProcedimento(listaPar, TipoPrimitivo.STRING, comando);}
                        }
                }

            {if (true) return new DefProcedimento (listaPar, null, comando);}
    throw new Error("Missing return statement in function");
    } finally {
  ...
  static final public DefCorotina PDefCorotina() throws ParseException {
    trace_call("PDefCorotina");
    try {
        ListaDeclaracaoParametro listaPar = null;
        Token retorno = null;
      ...
      default:
        ...
        throw new ParseException();
            ...
            if(retorno != null) {
                        if(retorno.kind == BOOLEAN) {
                                {if (true) return new DefCorotina(listaPar, TipoPrimitivo.BOOLEANO, comandoCorotina);}
                        }else if(retorno.kind == INT) {
                                {if (true) return new DefCorotina(listaPar, TipoPrimitivo.INTEIRO, comandoCorotina);}
                        }else {
                                {if (true) return new DefCorotina(listaPar, TipoPrimitivo.STRING, comandoCorotina);}
                        }
            }

            {if (true) return new DefCorotina(listaPar, null, comandoCorotina);}
    throw new Error("Missing return statement in function");
    } finally {
      trace_return("PDefCorotina");
    }
  }
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x74760000,0x300000,0x6000,0x6000,0x14006000,0x9800,0x14006000,0x74760000,0x1400f800,0x1400f800,0xa010000,0x2000000,0x8000000,0x80000000,0x0,0x80000000,0x0,0x80000000,0x80000000,0x0,0x80000000,0x0,0x80000000,0x80000000,0x80000000,0x0,0x1400f800,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x1480,0x0,0x0,0x44,0x4c4,0x0,0x4c4,0x1480,0x4c4,0x4c4,0x400,0x0,0x0,0x3,0x4000000,0x3,0x4000000,0x4021803,0x3,0x4000000,0x3,0x4000000,0x4021803,0x3,0x3,0x20000,0x4c4,0x20000,};
   }
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0x0,0x0,0x0,0x0,0x0,0x8,0x0,0x0,0x8,0x8,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x8,0x0,};
   }
